...
./vgan_corrected/bin/vgan haplocart -t 35 -fq1 test_data/human/B2b3a_damaged.fq --hc-files /home/projects/MAAG/Magpie/Magpie/vgan_corrected/share/vgan/hcfiles -np --show-work && echo -e "\n\n"
