...
./vg_corrected/bin/vg giraffe -f test_graph/test.fq -t 1 -m test_graph/test.min -q test_graph/test.ry \
                              -d test_graph/test.dist -Z test_graph/test.giraffe.gbz --show-work > test.gam && echo -e "\n\n"
...
#./vgan_corrected/bin/vgan euka -t 60 -fq1 test_graph/test.fq -t -1 --euka_dir test_graph --dbprefix test --outFrag
