...
#./vg_corrected/bin/vg minimizer -t 60 -p -g ../euka_dir/euka_db.gbwt -d ../euka_dir/euka_db.dist -o ../euka_dir/euka_db.min ../euka_dir/euka_db.og -k 10 -w 12 && echo -e "\n\n"
...
./vgan_corrected/bin/vgan euka -t 1 -fq1 test_data/three_dhigh_100.fq.gz --euka_dir /home/projects/MAAG/Magpie/euka_dir/ --outFrag
